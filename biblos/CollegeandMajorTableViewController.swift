//
//  CollegeandMajorTableViewController.swift
//  biblos
//
//  Created by Taylor Simpson on 1/24/18.
...
class CollegeandMajorTableViewController: UITableViewController, DZNEmptyDataSetSource, DZNEmptyDataSetDelegate  {
    ...
    override func viewWillAppear(_ animated: Bool) {
        self.title = "College and Major Results"
    }
    ...
    func grabSchools(){
        ...
        var ref = Database.database().reference().child("colleges").child(college).child(major)
           ...
           // print("I've Been Fired")
            ...
            for child in self.bookdIdArray {
                ...
                for keys in bookID.keys {
                    ...
                    print("I went!")
                    print("This is a key in the: " + keys)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "majors", for: indexPath) as! CollegeAndGenreCell
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if (segue.identifier == "uploadBook"){
        ...
        if (segue.identifier == "moreInfo") {
           ...
           // let moreInfoCells = moreInfoSnaphot.value as! Dictionary<String, String>
            ...
            let userToBePushed = book["pushingID"] as! String!
            let coditionOfBook = book["Condition"] as! String!
            let bookID = self.keyArray[indexPath.row]
            ...
            viewController.bookRequestedId = bookID
