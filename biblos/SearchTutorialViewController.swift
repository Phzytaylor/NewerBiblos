...
class SearchTutorialViewController: UIViewController {
    ...
    let items = [
        OnboardingItemInfo(informationImage: UIImage(named: "searchView.PNG")!,
                           title: "Search",
                           description: "You can search by genre, your college and major or just by major. It's as easy as tapping a cell,typing and hitting search!",
        ...
        OnboardingItemInfo(informationImage: UIImage(named: "GenreView.PNG")!,
                           title: "Genres",
                           description: "If you tapped search by Genre you will be lead here. Just tap a cell and see if there are any books. If not you will be prompted to add one of your own.",
                           pageIcon: UIImage(named: "checkMark.png")!,
                           color: UIColor(red: 0.40, green: 0.56, blue: 0.71, alpha: 1.00),
                           titleColor: UIColor.white, descriptionColor: UIColor.white, titleFont:  UIFont(name: "Helvetica", size: 20)!, descriptionFont:  UIFont(name: "Helvetica", size: 25)!),
        OnboardingItemInfo(informationImage: UIImage(named: "Results.PNG")!,
                           title: "Search Resutls",
                           description: "No matter how you searched you will end up here if books are available. Just give the book a tap!",
                           pageIcon: UIImage(named: "checkMark.png")!,
                           color: UIColor(red: 0.40, green: 0.56, blue: 0.71, alpha: 1.00),
                           titleColor: UIColor.white, descriptionColor: UIColor.white, titleFont:  UIFont(name: "Helvetica", size: 20)!, descriptionFont:  UIFont(name: "Helvetica", size: 25)!),
    ...
    extension SearchTutorialViewController: PaperOnboardingDataSource {
...
extension SearchTutorialViewController: PaperOnboardingDelegate {
