...
class UserTypeViewController: FormViewController {
    ...
    override func viewDidLoad() {
        ...
        form +++ Section("Enter Your College/School") { section in
            ...
            <<< TextRow(){ row in
                row.title = "Choose Your Major/Subject"
