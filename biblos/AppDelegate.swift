...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        OneSignal.initWithLaunchOptions(launchOptions, appId: "c439dfba-dd89-4901-becd-bf2131ed010e") { (result) in
            
            // This block gets called when the user reacts to a notification received
            
            let payload = result?.notification.payload
            let messageTitle = "Message Received"
           ...
           // let alertView = UIAlertView(title: messageTitle, message: fullMessage, delegate: nil, cancelButtonTitle: "Close")
            ...
            let alertView = UIAlertController(title: messageTitle, message: fullMessage, preferredStyle: .alert)
