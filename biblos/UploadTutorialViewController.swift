//
//  UploadTutorialViewController.swift
//  biblos
//
...
class UploadTutorialViewController: UIViewController {
    ...
    let items = [
        OnboardingItemInfo(informationImage: UIImage(named: "Upload.PNG")!,
                           title: "Give me some info.",
                           description: "Fill out some information about your book in the provided fields.",
        ...
        OnboardingItemInfo(informationImage: UIImage(named: "Confirm.PNG")!,
                           title: "Upload it.",
                           description: "After you have filled out all information just tap the upload button",
                           pageIcon: UIImage(named: "checkMark.png")!,
                           color: UIColor(red: 0.40, green: 0.56, blue: 0.71, alpha: 1.00),
                           titleColor: UIColor.white, descriptionColor: UIColor.white, titleFont:  UIFont(name: "Helvetica", size: 20)!, descriptionFont:  UIFont(name: "Helvetica", size: 25)!),
...
extension UploadTutorialViewController: PaperOnboardingDataSource {
...
extension UploadTutorialViewController: PaperOnboardingDelegate {
